const interval_fractal_tree = function (container,length = 200,angle_span=90,mode=[0,2,4,5,7,9,11],intervals=[-1,1],keep_alive=true,save_image=false, edo=12, iterations=5,length_mul=0.7) {
    container.innerHTML = ""
